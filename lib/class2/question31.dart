...
import 'package:quiz_app/class2/question32.dart';
import 'package:quiz_app/endscreen.dart';

class Question31Class2 extends StatefulWidget {
  const Question31Class2({super.key});

  @override
  State<Question31Class2> createState() => _Question31Class2State();
}

class _Question31Class2State extends State<Question31Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar empat buah berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_31.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Urutan berat buah dari yang paling ringan sampai dengan yang paling berat adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question32Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item31.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (13527 <= event.inMilliseconds && event.inMilliseconds <= 14500) {
          isVisibleAnswerA = true;
        } else if (20226 <= event.inMilliseconds &&
            event.inMilliseconds <= 21500) {
          isVisibleAnswerB = true;
        } else if (26903 <= event.inMilliseconds &&
            event.inMilliseconds <= 27500) {
          isVisibleAnswerC = true;
        } else if (33265 <= event.inMilliseconds &&
