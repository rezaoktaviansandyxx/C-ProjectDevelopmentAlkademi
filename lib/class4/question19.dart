...
class Question19Class4 extends StatefulWidget {
  const Question19Class4({super.key});

  @override
  State<Question19Class4> createState() => _Question19Class4State();
}

class _Question19Class4State extends State<Question19Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan barisan bilangan di bawah ini yang selisih antara dua bilangan yang berurutan adalah sama!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_19.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila bilangan pada kotak kosong dikurangi 19 maka hasilnya adalah ….',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
