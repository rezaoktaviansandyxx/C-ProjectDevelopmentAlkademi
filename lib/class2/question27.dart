...
import 'package:quiz_app/class2/question28.dart';
...
class _Question27Class2State extends State<Question27Class2> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question28Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item27.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (17884 <= event.inMilliseconds && event.inMilliseconds <= 18500) {
          isVisibleAnswerA = true;
        } else if (19992 <= event.inMilliseconds &&
            event.inMilliseconds <= 20500) {
          isVisibleAnswerB = true;
        } else if (22084 <= event.inMilliseconds &&
            event.inMilliseconds <= 23500) {
          isVisibleAnswerC = true;
        } else if (24206 <= event.inMilliseconds &&
