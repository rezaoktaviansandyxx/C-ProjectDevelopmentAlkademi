...
class Question32Class4 extends StatefulWidget {
  const Question32Class4({super.key});

  @override
  State<Question32Class4> createState() => _Question32Class4State();
}

class _Question32Class4State extends State<Question32Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Diilustrasikan seorang anak sedang bermain puzzle.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_32.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Anak tersebut menemukan enam potongan puzzle yang berbentuk segitiga sama sisi. Keenam segitiga tersebut dirangkai dan manjadi bangun datar yang baru.\n\nMenurut kalian bangun apakah yang dapat terbentuk?',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
