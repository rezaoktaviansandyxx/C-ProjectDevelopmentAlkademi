...
class Question28Class4 extends StatefulWidget {
  const Question28Class4({super.key});

  @override
  State<Question28Class4> createState() => _Question28Class4State();
}

class _Question28Class4State extends State<Question28Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Sehelai taplak menutupi penuh sebuah meja seperti pada gambar di bawah ini.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_28.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila keliling taplak meja adalah 240 cm, maka luas meja tersebut adalah ….',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
