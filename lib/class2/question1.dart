        ...
        child: Column(
          children: [
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Di antara 4 pilihankumpulan gambar buah jeruk yang tersedia, kumpulan gambar jeruk yang paling banyak jumlahnya dibandingkan dengan kumpulan gambar jeruk pada gambar diatas adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
