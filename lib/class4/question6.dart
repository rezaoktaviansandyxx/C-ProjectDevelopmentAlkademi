...
class Question6Class4 extends StatefulWidget {
  const Question6Class4({super.key});

  @override
  State<Question6Class4> createState() => _Question6Class4State();
}

class _Question6Class4State extends State<Question6Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_6.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Arina secara rutin menabung di dua celengan miliknya yang berbentuk tabung sebagaimana tampak pada gambar di atas. Arina sejak awal memasukkan 5.000 rupiah ke setiap celengan, setiap hari tanpa henti. Ketika kedua celengannya dibuka ternyata uang tabungannya berjumlah Rp.520.000,00. Dapat kita simpulkan bahwa Arina telah menabung selama. ...hari.',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
