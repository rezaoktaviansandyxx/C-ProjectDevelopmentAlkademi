...
class Question3Class4 extends StatefulWidget {
  const Question3Class4({super.key});

  @override
  State<Question3Class4> createState() => _Question3Class4State();
}

class _Question3Class4State extends State<Question3Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_3.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Pak Adi, Bu Rini dan Edo dengan barang bawaan masing-masing akan masuk ke dalam sebuah lift, sementara di dalam lift sudah ada 4 orang penumpang dengan jumlah berat badan 300 Kilogram. Berat maksimum barang bawaan mereka bertiga agar kapasitas lift memenuhi syarat adalah. ... Kilogram.',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class4/item3.mp3'),
      autoStart: true,
    );
