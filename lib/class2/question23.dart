...
import 'package:quiz_app/class2/question24.dart';
import 'package:quiz_app/endscreen.dart';

class Question23Class2 extends StatefulWidget {
  const Question23Class2({super.key});

  @override
  State<Question23Class2> createState() => _Question23Class2State();
}

class _Question23Class2State extends State<Question23Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar botol dan kemasan air mineral berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_23.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila air mineral dalam botol dan kemasan sebagaimana tampak pada gambar di atas digabungkan dalam satu wadah, keseluruhan volumenya. ... mililiter (ml)',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question24Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item23.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (24850 <= event.inMilliseconds && event.inMilliseconds <= 25500) {
          isVisibleAnswerA = true;
        } else if (27237 <= event.inMilliseconds &&
            event.inMilliseconds <= 28500) {
          isVisibleAnswerB = true;
        } else if (29337 <= event.inMilliseconds &&
            event.inMilliseconds <= 30500) {
          isVisibleAnswerC = true;
        } else if (31166 <= event.inMilliseconds &&
