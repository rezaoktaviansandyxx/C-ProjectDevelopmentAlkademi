...
class Question20Class4 extends StatefulWidget {
  const Question20Class4({super.key});

  @override
  State<Question20Class4> createState() => _Question20Class4State();
}

class _Question20Class4State extends State<Question20Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Misalkan terdapat barisan bilangan dengan hasil bagi antara dua bilangan adalah sama, seperti barisan berikut ini.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_20.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila bilangan pada kotak kosong dibagi 9 maka hasilnya adalah ….',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
