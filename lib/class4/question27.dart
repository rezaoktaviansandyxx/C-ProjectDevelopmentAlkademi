...
class Question27Class4 extends StatefulWidget {
  const Question27Class4({super.key});

  @override
  State<Question27Class4> createState() => _Question27Class4State();
}

class _Question27Class4State extends State<Question27Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Sebuah ruangan akan dipasang ubin dengan ukuran 30 x 30 centimeter sebagaimana tampak pada gambar berikut ini.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_27.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila untuk menutupi penuh seluruh lantai ruangan tersebut diperlukan 150 keping ubin, berapakah kemungkinan ukuran panjang dan lebar ruangan tersebut?',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
