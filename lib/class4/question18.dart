...
class Question18Class4 extends StatefulWidget {
  const Question18Class4({super.key});

  @override
  State<Question18Class4> createState() => _Question18Class4State();
}

class _Question18Class4State extends State<Question18Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Diketahui ☼ dan ♣ adalah dua buah bilangan yang berbeda, dan nilai ☼ lebih besar daripada nilai ♣. \n\nApabila (3x☼) : (2x♣) = 3, maka ☼ dan ♣ adalah bilangan … dan ….',
                style: TextStyle(
                  fontSize: 14,
