...
class Question16Class4 extends StatefulWidget {
  const Question16Class4({super.key});

  @override
  State<Question16Class4> createState() => _Question16Class4State();
}

class _Question16Class4State extends State<Question16Class4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Image.asset('assets/images/class4/setb_img_soal_no_16.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              ...
              child: Text(
                'Iqbal dan Fahmi 2 orang yang bersahabat dan mereka memiliki kegemaran yang sama, yaitu bermain kelereng. Jumlah kelereng mereka masing-masing sama banyak, sedangkan Iqbal menyimpan kelerengnya pada 2 kantong dan sama banyak. Berapa isi masing-masing kantong kelereng milik Iqbal?',
                style: TextStyle(
                  fontSize: 14,
