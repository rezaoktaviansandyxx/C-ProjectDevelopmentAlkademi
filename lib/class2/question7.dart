...
import 'package:quiz_app/class2/question8.dart';
import 'package:quiz_app/endscreen.dart';

class Question7Class2 extends StatefulWidget {
  const Question7Class2({super.key});

  @override
  State<Question7Class2> createState() => _Question7Class2State();
}

class _Question7Class2State extends State<Question7Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Hari ini Hana berulang tahun. Ia akan memotong kue ulang tahunnya menjadi 4 bagian sama besar. Gambar yang menunjukkan cerita memotong kue tersebut agar keempat bagiannya sama besar adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 3,
                                  child: Image.asset(
                                    'assets/images/class2/seta_img_soal_no_7a.png',
                                    fit: BoxFit.contain,
                                  ),
                                ),
                              ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_7b.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_7c.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_7d.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question8Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item7.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (22187 <= event.inMilliseconds && event.inMilliseconds <= 23500) {
          isVisibleAnswerA = true;
        } else if (24590 <= event.inMilliseconds &&
            event.inMilliseconds <= 25500) {
          isVisibleAnswerB = true;
        } else if (26374 <= event.inMilliseconds &&
            event.inMilliseconds <= 27500) {
          isVisibleAnswerC = true;
        } else if (28203 <= event.inMilliseconds &&
