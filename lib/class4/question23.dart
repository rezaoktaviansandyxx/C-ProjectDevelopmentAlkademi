...
class Question23Class4 extends StatefulWidget {
  const Question23Class4({super.key});

  @override
  State<Question23Class4> createState() => _Question23Class4State();
}

class _Question23Class4State extends State<Question23Class4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Image.asset('assets/images/class4/setb_img_soal_no_23.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              ...
              child: Text(
                'Untuk menghias sebuah kado, seorang anak ingin membuat sebuah pita seperti pada gambar. Untuk membuat pita tersebut, dibutuhkan 35 cm pita ungu dan 220mm pita putih. Apabila akan dibuat 4 kado sehingga dibutuhkan 4 pita, berapa meter total panjang pita yang dibutuhkan?',
                style: TextStyle(
                  fontSize: 14,
