...
class Question21Class4 extends StatefulWidget {
  const Question21Class4({super.key});

  @override
  State<Question21Class4> createState() => _Question21Class4State();
}

class _Question21Class4State extends State<Question21Class4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Image.asset('assets/images/class4/setb_img_soal_no_21.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              ...
              child: Text(
                'Seorang ibu sedang berbelanja dan membeli 2 kantong kentang dan 3 kantong telur. Berat keseluruhan belanjaan ibu tersebut adalah ….',
                style: TextStyle(
                  fontSize: 14,
