...
class Question2Class4 extends StatefulWidget {
  const Question2Class4({super.key});

  @override
  State<Question2Class4> createState() => _Question2Class4State();
}

class _Question2Class4State extends State<Question2Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_2.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Pak Adi, Bu Rini dan Edo akan masuk ke dalam sebuah lift, sementara di dalam lift sudah ada 5 orang penumpang dengan jumlah berat badan kelimanya 420 Kilogram. Agar kapasitas lift masih memenuhi syarat, yang memungkinkan untuk masuk ke dalam lift tersebut adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class4/item2.mp3'),
      autoStart: true,
    );
