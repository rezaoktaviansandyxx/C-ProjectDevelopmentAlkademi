...
class Question31Class4 extends StatefulWidget {
  const Question31Class4({super.key});

  @override
  State<Question31Class4> createState() => _Question31Class4State();
}

class _Question31Class4State extends State<Question31Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Apabila kita memiliki empat buah bangun segitiga seperti pada gambar berikut dan kemudian kita akan menyusun keempat bangun tersebut menjadi bangun yang baru.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_31.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Menurut kalian bangun apa yang mungkin dapat disusun?',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 3,
                                  child: Image.asset(
                                    'assets/images/class4/setb_img_soal_no_31a.png',
                                    fit: BoxFit.contain,
                                  ),
                                ),
                              ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_31b.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_31c.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_31d.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
