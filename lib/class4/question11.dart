...
class Question11Class4 extends StatefulWidget {
  const Question11Class4({super.key});

  @override
  State<Question11Class4> createState() => _Question11Class4State();
}

class _Question11Class4State extends State<Question11Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar bilangan pecahan berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_11.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Di antara keempat pilihan jawaban di bawah ini, bilangan yang nilainya lebih besar dari bilangan pecahan pada gambar di atas adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
