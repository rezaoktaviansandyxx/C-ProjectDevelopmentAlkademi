...
class _Question34Class2State extends State<Question34Class2> {
  ...
  openPlayer() async {
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (26672 <= event.inMilliseconds && event.inMilliseconds <= 27500) {
          isVisibleAnswerA = true;
        } else if (28768 <= event.inMilliseconds &&
            event.inMilliseconds <= 29500) {
          isVisibleAnswerB = true;
        } else if (31162 <= event.inMilliseconds &&
            event.inMilliseconds <= 32500) {
          isVisibleAnswerC = true;
        } else if (33279 <= event.inMilliseconds &&
