...
class Question26Class4 extends StatefulWidget {
  const Question26Class4({super.key});

  @override
  State<Question26Class4> createState() => _Question26Class4State();
}

class _Question26Class4State extends State<Question26Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Terdapat sebuah cermin berbentuk bidang lingkaran yang dibingkai dengan kayu sebagaimana tampak pada gambar berikut ini.',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_26.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila keliling bingkai kayu bagian tepi dalam adalah 2,2 meter, maka jari-jari kaca cermin adalah … centimeter',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
