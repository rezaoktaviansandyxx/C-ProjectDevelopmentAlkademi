...
class Question7Class4 extends StatefulWidget {
  const Question7Class4({super.key});

  @override
  State<Question7Class4> createState() => _Question7Class4State();
}

class _Question7Class4State extends State<Question7Class4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Image.asset('assets/images/class4/setb_img_soal_no_7.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              ...
              child: Text(
                'Bu Ana mempunyai 10 buah apel, 6 buah jeruk dan 8 buah salak sebagaimana tampak pada gambar. Jika Bu Ana akan membagikannya sampai habis ketiga jenis buah-buahan tersebut kepada semua anaknya sama banyak, maka jumlah anak Bu Ana adalah. ... orang.',
                style: TextStyle(
                  fontSize: 14,
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class4/item7.mp3'),
      autoStart: true,
    );
