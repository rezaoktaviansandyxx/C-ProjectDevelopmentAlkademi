...
class Question17Class4 extends StatefulWidget {
  const Question17Class4({super.key});

  @override
  State<Question17Class4> createState() => _Question17Class4State();
}

class _Question17Class4State extends State<Question17Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Misalkan terdapat teka-teki seperti berikut.',
                style: TextStyle(
                  fontSize: 14,
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                '☼   +    ♣   -  2 = 38\n\nApabila ☼ dan ♣ digantikan dengan bilangan tertentu, dan ☼ lebih besar daripada ♣.  Dari pilihan jawaban berikut ini, pilihan jawaban yang tepat adalah',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
