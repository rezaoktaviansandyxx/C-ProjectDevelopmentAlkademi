...
class Question10Class4 extends StatefulWidget {
  const Question10Class4({super.key});

  @override
  State<Question10Class4> createState() => _Question10Class4State();
}

class _Question10Class4State extends State<Question10Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Hari ini Ibu berulang tahun. Ia akan membagikan kue ulang tahunnya kepada Alfi dan Alfian dengan pola potongan sebagaimana tampak pada gambar berikut!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_10.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Alfi mendapatkan 3/8 bagian, sedangkan Alfian mendapatkan 1/4 bagian. Pernyataan yang tepat terkait dengan pembagian kue tersebut adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Expanded(
                              child: Text(
                                'A. Potongan kue milik Alfi lebih besar dibandingkan dengan potongan kue milik Alfian',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xff006699),
                                ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Expanded(
                                child: Text(
                                  'B. Potongan kue milik Alfian lebih besar dibandingkan dengan potongan kue milik Alfi',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Color(0xff006699),
                                  ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Expanded(
                                child: Text(
                                  'C. Potongan kue milik Alfi lebih kecil dibandingkan dengan potongan kue milik Alfian',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Color(0xff006699),
                                  ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Expanded(
                                child: Text(
                                  'D. Potongan kue milik Alfi dan Alfian sama besar',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Color(0xff006699),
                                  ),
