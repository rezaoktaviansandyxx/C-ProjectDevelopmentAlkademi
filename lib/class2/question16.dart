...
import 'package:quiz_app/class2/question17.dart';
import 'package:quiz_app/endscreen.dart';

class Question16Class2 extends StatefulWidget {
  const Question16Class2({super.key});

  @override
  State<Question16Class2> createState() => _Question16Class2State();
}

class _Question16Class2State extends State<Question16Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar permen loli pop berwarna merah, kuning dan biru milik Safira berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_16.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Apabila Safira  memberikan 6 permen berwarna kuning kepada beberapa temannya, maka pernyataan yang paling tepat di antara pernyataan-pernyataan di bawah ini adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question17Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item16.mp3'),
      autoStart: true,
    );
