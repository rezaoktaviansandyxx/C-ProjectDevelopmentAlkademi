...
import 'package:quiz_app/class2/question7.dart';
...
class _Question6Class2State extends State<Question6Class2> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question7Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item6.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (28467 <= event.inMilliseconds && event.inMilliseconds <= 29500) {
          isVisibleAnswerA = true;
        } else if (30880 <= event.inMilliseconds &&
            event.inMilliseconds <= 31500) {
          isVisibleAnswerB = true;
        } else if (33278 <= event.inMilliseconds &&
            event.inMilliseconds <= 34500) {
          isVisibleAnswerC = true;
        } else if (35127 <= event.inMilliseconds &&
