...
import 'package:quiz_app/class2/question10.dart';
import 'package:quiz_app/endscreen.dart';

class Question9Class2 extends StatefulWidget {
  const Question9Class2({super.key});

  @override
  State<Question9Class2> createState() => _Question9Class2State();
}

class _Question9Class2State extends State<Question9Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan keempat gambar yang berwarna merah dan putih pada pilihan di bawah ini! Apabila bagian yang berwarna merah dibandingkan dengan keseluruhan pada setiap gambar, maka gambar yang menunjukkan nilai bilangan pecahan seperempat adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 3,
                                  child: Image.asset(
                                    'assets/images/class2/seta_img_soal_no_9a.png',
                                    fit: BoxFit.contain,
                                  ),
                                ),
                              ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_9b.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_9c.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class2/seta_img_soal_no_9d.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question10Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item9.mp3'),
      autoStart: true,
    );
