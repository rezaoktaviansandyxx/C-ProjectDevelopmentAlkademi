...
class Question12Class4 extends StatefulWidget {
  const Question12Class4({super.key});

  @override
  State<Question12Class4> createState() => _Question12Class4State();
}

class _Question12Class4State extends State<Question12Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_12.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Mereka diminta berbaris sesuai dengan urutan nilai bilangan yang mereka pegang. Jika mereka berlima berdiri dari depan ke belakang, dengan urutan dari nilai bilangan yang terbesar ke terkecil, maka siswa yang berada tepat di belakang Edo adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
