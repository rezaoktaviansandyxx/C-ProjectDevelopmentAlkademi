...
class Question14Class4 extends StatefulWidget {
  const Question14Class4({super.key});

  @override
  State<Question14Class4> createState() => _Question14Class4State();
}

class _Question14Class4State extends State<Question14Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan data pengunjung perpustakaan berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_14.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Selisih banyak pengunjung perpustakan pada hari Jumat dan Sabtu adalah 1 orang. Jika banyak pengunjung perpustakaan selama 6 hari berturut-turut adalah 100 orang, maka kemungkinan banyak pengunjung perpustakaan pada hari Jumat dan Sabtu berturut-turut adalah ... orang.',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
