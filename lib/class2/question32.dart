...
import 'package:quiz_app/class2/question33.dart';
import 'package:quiz_app/endscreen.dart';

class Question32Class2 extends StatefulWidget {
  const Question32Class2({super.key});

  @override
  State<Question32Class2> createState() => _Question32Class2State();
}

class _Question32Class2State extends State<Question32Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar empat kegiatan yang Arsya lakukan berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_32.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Urutan kegiatan Arsya dari yang paling sebentar sampai dengan yang paling lama adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                      ...
                      child: Flexible(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Text(
                              'A. Belajar, makan, tidur, bermain bola',
                              style: TextStyle(
                                fontSize: 14,
                                color: Color(0xff006699),
                              ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Text(
                                'B. Makan, belajar, bermain bola, tidur',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xff006699),
                                ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Text(
                                'C. Belajar, tidur, bermain bola, makan',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xff006699),
                                ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: const Text(
                                'D. Makan, bermain bola, belajar, tidur',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Color(0xff006699),
                                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question33Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item32.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (17277 <= event.inMilliseconds && event.inMilliseconds <= 18500) {
          isVisibleAnswerA = true;
        } else if (23658 <= event.inMilliseconds &&
            event.inMilliseconds <= 24500) {
          isVisibleAnswerB = true;
        } else if (30564 <= event.inMilliseconds &&
            event.inMilliseconds <= 31500) {
          isVisibleAnswerC = true;
        } else if (37789 <= event.inMilliseconds &&
            event.inMilliseconds <= 38500) {
