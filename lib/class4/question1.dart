        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan penjumlahan dua bilangan berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_1.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Bilangan yang tepat untuk mengganti nilai A dan B berturut-turut pada operasi penjumlahan tersebut adalah bilangan. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
