...
class Question2Class2 extends StatefulWidget {
  ...
  @override
  State<Question2Class2> createState() => _Question2Class2State();
}
...
class _Question2Class2State extends State<Question2Class2> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_2.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Di antara 4 pilihan bilangan yang tersedia, bilangan yang paling kecil nilainya dibandingkan dengan bilangan pada gambar di atas adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item2.mp3'),
      autoStart: true,
    );
