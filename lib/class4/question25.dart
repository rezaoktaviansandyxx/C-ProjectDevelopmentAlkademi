...
class Question25Class4 extends StatefulWidget {
  const Question25Class4({super.key});

  @override
  State<Question25Class4> createState() => _Question25Class4State();
}

class _Question25Class4State extends State<Question25Class4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Image.asset('assets/images/class4/setb_img_soal_no_25.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              ...
              child: Text(
                'Seorang penjahit akan membuat taplak meja yang serupa dengan gambar. Taplak meja berbentuk segi empat tersebut akan dipasang renda. Apabila renda yang dibutuhkan untuk menghiasi taplak tersebut adalah 4,2 meter, dan lebar taplak sebelum dipasang renda adalah adalah 90 centimeter, maka panjang taplak sebelum dipasang renda adalah … centimeter',
                style: TextStyle(
                  fontSize: 14,
