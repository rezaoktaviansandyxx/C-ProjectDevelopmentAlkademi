...
class Question14Class2 extends StatefulWidget {
  ...
  @override
  State<Question14Class2> createState() => _Question14Class2State();
}

class _Question14Class2State extends State<Question14Class2> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_14.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Dua persegi kosong diberi kode A dan B. Bilangan yang tepat untuk mengisi A dan B berturut-turut adalah ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question15Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item14.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (19750 <= event.inMilliseconds && event.inMilliseconds <= 20500) {
          isVisibleAnswerA = true;
        } else if (21871 <= event.inMilliseconds &&
            event.inMilliseconds <= 22500) {
          isVisibleAnswerB = true;
        } else if (23937 <= event.inMilliseconds &&
            event.inMilliseconds <= 24500) {
          isVisibleAnswerC = true;
        } else if (26063 <= event.inMilliseconds &&
