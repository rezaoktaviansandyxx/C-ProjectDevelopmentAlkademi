...
class Question13Class4 extends StatefulWidget {
  const Question13Class4({super.key});

  @override
  State<Question13Class4> createState() => _Question13Class4State();
}

class _Question13Class4State extends State<Question13Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_13.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Jika banyak pengunjung perpustakaan selama 6 hari berturut-turut adalah 100 orang, maka banyak pengunjung perpustakaan pada hari Jumat adalah...orang.',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
