...
class _Question28Class2State extends State<Question28Class2> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Coba perhatikan gambar 5 orang anak berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_28.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Berdasarkan gambar di atas, nama anak laki-laki yang berat badannya lebih berat dari Ali adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item28.mp3'),
      autoStart: true,
    );
