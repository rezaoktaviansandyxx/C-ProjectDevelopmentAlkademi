...
class Question15Class4 extends StatefulWidget {
  const Question15Class4({super.key});

  @override
  State<Question15Class4> createState() => _Question15Class4State();
}

class _Question15Class4State extends State<Question15Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Perhatikan gambar seorang ibu berikut ini!',
                style: TextStyle(
                  fontSize: 14,
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_15.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Ibu tersebut memasukkan 19 telur di keranjang. Setelah dihitung semuanya, ternyata jumlah telur menjadi 37 buah. Berapakah telur yang dimasukkan sebelumnya?',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
