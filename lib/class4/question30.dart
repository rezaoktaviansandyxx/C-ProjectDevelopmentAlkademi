...
class Question30Class4 extends StatefulWidget {
  const Question30Class4({super.key});

  @override
  State<Question30Class4> createState() => _Question30Class4State();
}

class _Question30Class4State extends State<Question30Class4> {
        ...
        child: Column(
          children: [
            const Align(
              ...
              child: Text(
                'Terdapat dua buah bangun datar dengan ciri-ciri sebagai berikut:\n- Kedua benda tersebut memiliki tiga buah sisi.\n- Bangun datar pertama memiliki besar sudut masing-masing 60 derajat.\n- Bangun datar kedua, besar masing-masing sudut berbeda.\n\nBangun datar apakah yang dimaksud?',
                style: TextStyle(
                  fontSize: 14,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 3,
                                  child: Image.asset(
                                    'assets/images/class4/setb_img_soal_no_30a.png',
                                    fit: BoxFit.contain,
                                  ),
                                ),
                              ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_30b.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_30c.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    flex: 3,
                                    child: Image.asset(
                                      'assets/images/class4/setb_img_soal_no_30d.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ],
