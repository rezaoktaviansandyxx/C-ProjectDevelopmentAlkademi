...
class Question5Class4 extends StatefulWidget {
  const Question5Class4({super.key});

  @override
  State<Question5Class4> createState() => _Question5Class4State();
}

class _Question5Class4State extends State<Question5Class4> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class4/setb_img_soal_no_5.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Arina secara rutin menabung di dua celengan miliknya sebagaimana tampak pada gambar di atas. Jika Arina sejak awal menabung Rp.5.000,00 setiap hari tanpa henti, maka dalam 4 minggu jumlah tabungan pada kedua celengannya adalah. ...',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class4/item5.mp3'),
      autoStart: true,
    );
