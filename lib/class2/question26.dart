...
import 'package:quiz_app/class2/question27.dart';

class Question26Class2 extends StatefulWidget {
  const Question26Class2({super.key});

  @override
  State<Question26Class2> createState() => _Question26Class2State();
}

class _Question26Class2State extends State<Question26Class2> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/class2/seta_img_soal_no_26.png'),
            const SizedBox(
              height: 5,
            ),
            const Align(
              alignment: Alignment.centerLeft,
              child: Text(
                'Anisa pulang dari sekolah pada pukul 13.00. Karena ditempuh dengan berjalan kaki, ia membutuhkan waktu lebih lama dibandingkan dengan menggunakan angkutan umum. Jika ia tiba di rumah pada jam 14.00, maka perjalanan yang ditempuh Anisa adalah selama. ... menit',
                style: TextStyle(
                  fontSize: 14,
                  color: Color(0xff006699),
                ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Question27Class2()));
                    },
  ...
  openPlayer() async {
    await _assetAudioPlayer.open(
      Audio('assets/audios/class2/item26.mp3'),
      autoStart: true,
    );
    ...
    _assetAudioPlayer.currentPosition.listen((event) {
      setState(() {
        if (33547 <= event.inMilliseconds && event.inMilliseconds <= 34500) {
          isVisibleAnswerA = true;
        } else if (35527 <= event.inMilliseconds &&
            event.inMilliseconds <= 36500) {
          isVisibleAnswerB = true;
        } else if (37945 <= event.inMilliseconds &&
            event.inMilliseconds <= 38500) {
          isVisibleAnswerC = true;
        } else if (39923 <= event.inMilliseconds &&
